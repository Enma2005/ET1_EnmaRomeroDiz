class articulo extends EntidadAbstracta {
	...
	manual_form_creation() {
		...
		var form_content = `
				...
				<label id="label_FicheropdfA" class="label_FicheropdfA">pdf Acto</label>
	...
	*/
	...
	ADD_nuevo_FicheropdfA_validation() {
		...
		if (!(this.validations.format_name_file('nuevo_FicheropdfA', '^[a-zA-Z._]+$'))) {
